...
const adminSidebar = {
  ...
  subscriptionBilling: {
    ...
    children: {
      packages: {
        title: "Packages",
        path: "/subscription-billing/packages",
      ...
      activeSubscriptions: {
        ...
        path: "/subscription-billing/active-subscriptions",
        description: "View all active subscriptions",
      },
      billingSettings: {
        title: "Billing Settings",
        path: "/subscription-billing/billing-settings",
  ...
  academicHierarchy: {
    ...
    children: {
      manageBoards: {
        title: "Manage Boards",
        path: "/academic-hierarchy/manage-boards",
      },
      manageClasses: {
        title: "Manage Classes",
        path: "/academic-hierarchy/manage-classes",
      },
      manageSubjects: {
        title: "Manage Subjects",
        path: "/academic-hierarchy/manage-subjects",
      },
      requests: {
        title: "Requests",
        path: "/academic-hierarchy/requests",
  ...
  questionBank: {
    ...
    children: {
      ...
      importQuestions: {
        ...
        path: "/question-bank/import-questions",
        description: "Bulk upload via Excel/CSV",
      },
      questionApproval: {
        title: "Question Approval",
        path: "/question-bank/question-approval",
  ...
  questionSetAnalytics: {
    ...
    children: {
      generatedSets: {
        ...
        path: "/question-set-analytics/generated-sets",
        description: "By customer, board, class",
      },
      difficultyDistribution: {
        title: "Difficulty Distribution Reports",
        path: "/question-set-analytics/difficulty-distribution",
      },
      exportLogs: {
        title: "Export Logs",
        path: "/question-set-analytics/export-logs",
  ...
  integrations: {
    ...
    children: {
      boardAPIs: {
        title: "Board APIs",
        path: "/integrations/board-apis",
        description: "CBSE, ICSE, State Boards, etc.",
      },
      thirdPartyServices: {
        title: "3rd Party Services",
        path: "/integrations/third-party-services",
  ...
  const icons = {
    ...
    support: (
      <svg
        ...
        viewBox="0 0 16 16"
      >
        <path d="M11.442 4.576a1 1 0 1 0-1.634-1.152L4.22 11.35 1.773 8.366A1 1 0 1 0 .227 9.634l3.281 4a1 1 0 0 0 1.59-.058l6.344-9ZM15.817 4.576a1 1 0 0 0-1.634-1.152l-5.609 7.957a1 1 0 0 0-1.347 1.453l.656.8a1 1 0 0 0 1.59-.058l6.344-9Z" />
      </svg>
    ),
  };
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {Object.entries(adminSidebar).map(([key, item]) => (
                <SidebarLinkGroup
                  key={key}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg
                              ...
                              viewBox="0 0 16 16"
                            >
                              {icons[key] && icons[key].props.children}
                            </svg>
                        ...
                        <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                          <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                            {Object.entries(item.children).map(
                              ([childKey, child]) => (
                                <li className="mb-1 last:mb-0" key={childKey}>
                                  <NavLink
                                    end
                                    to={`/admin${child.path}`}
                                    className={({ isActive }) =>
